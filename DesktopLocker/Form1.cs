...
namespace DesktopLocker{
    public partial class Form1:Form{
        ...
        private void button1_Click(object sender,EventArgs e){if(textBox1.Text=="unlock"){check=false;Application.Exit();}}
        private void Form1_FormClosing(object sender,FormClosingEventArgs e){if(check){e.Cancel = true;}}
    }
}
